...
input_path  <- file.path("..", "Data_New", "Opening_Night_Operas_it_raw.csv")

output_clean_path         <- file.path("..", "Data_New", "Opening_Night_Operas_it_cleaned.csv")
output_nomilan_path       <- file.path("..", "Data_New", "Opening_Night_Operas_it_nomilan.csv")
output_novenice_path      <- file.path("..", "Data_New", "Opening_Night_Operas_it_novenice.csv")
output_nomilanvenice_path <- file.path("..", "Data_New", "Opening_Night_Operas_it_nomilanvenice.csv")
