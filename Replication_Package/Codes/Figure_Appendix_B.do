...
* 'gen' creates a variable that is 1 if the condition is true, 0 otherwise.
* When we sum these later, we get the count of operas satisfying the condition.
gen count_operas = 1
...
* 5. Replace missing values (generated by fillin) with 0
